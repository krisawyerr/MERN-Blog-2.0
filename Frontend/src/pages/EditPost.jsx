        ...
        <div className="fullPage">
            ...
            <div className="mainSection">
                ...
                <div className='createPost'>
                    <h1 className='spacing'>Update a post</h1>
                    <form className='createPostForm'>
                        <input onChange={(e)=>setTitle(e.target.value)} value={title} type="text" placeholder='Enter post title' className='spacing createPostTitle'/>
                        ...
                        <textarea onChange={(e)=>setDescription(e.target.value)} value={description} className='spacing createPostTextarea' placeholder='Enter post description'/>
                        ...
                        <button onClick={handleUpdate} className='spacing createPostButton'>Update</button>
                    </form>
                </div>
                <Footer/>
            </div>
