            ...
            <div className="bluee">
                ...
                <div className='px-6 md:px-[200px] mt-8'>
                    ...
                    <form className='w-full flex flex-col space-y-4 md:space-y-8 mt-4'>
                        <input onChange={(e)=>setTitle(e.target.value)} value={title} type="text" placeholder='Enter post title' className='blk px-4 py-2 outline-none'/>
                        ...
                        <textarea onChange={(e)=>setDescription(e.target.value)} value={description} className='blk px-4 py-2 outline-none h-96' placeholder='Enter post description'/>
                        <div>
